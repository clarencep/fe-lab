...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react__ = __webpack_require__(22);
...
var Accordion = function (_React$Component) {
    __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(Accordion, _React$Component);

    function Accordion(props) {
        __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, Accordion);

        var _this = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Accordion.__proto__ || __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of___default()(Accordion)).call(this, props));
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Accordion, [{
        ...
        value: function render() {
            ...
            var expendedItemStyle = {
                width: props.expandedPercent + '%',
                marginLeft: props.itemsGap,
                height: props.itemsHeight
            };
            var unexpanedItemStyle = {
                width: 'calc(' + (100 - props.expandedPercent) / (props.items.length - 1) + '% - ' + props.itemsGap + 'px)',
                marginLeft: props.itemsGap,
                height: props.itemsHeight
            };

            var expandedIndex = state.expandedIndex >= props.items.length ? props.items.length - 1 : state.expandedIndex;

            return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
                'div',
                { className: 'accordion', style: { height: props.itemsHeight } },
                props.items.map(function (item, i) {
                    return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(AccordionItem, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, item, { key: i,
                        expanded: i === expandedIndex,
                        style: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, i === expandedIndex ? expendedItemStyle : unexpanedItemStyle, i === 0 ? { marginLeft: 0 } : {}),
                        onClick: function onClick() {
                            return _this2.expandTo(i);
                        } }));
                })
            );
        }
...
var AccordionItem = function (_React$Component2) {
    __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(AccordionItem, _React$Component2);

    function AccordionItem() {
        __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, AccordionItem);

        return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (AccordionItem.__proto__ || __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of___default()(AccordionItem)).apply(this, arguments));
    }

    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(AccordionItem, [{
        key: 'render',
        value: function render() {
            var state = this.state,
                props = this.props;
            ...
            return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
                'div',
                { className: 'accordion-item ' + (props.expanded && 'expanded '),
                    style: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({ background: props.bkg }, props.style),
                    onClick: props.onClick },
                __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
                    'div',
                    { className: 'accordion-item-text' },
                    props.expanded ? props.text : props.short
                )
            );
        }
    }]);
...
var App = function (_React$Component3) {
    __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(App, _React$Component3);

    function App(props) {
        __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, App);

        var _this4 = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (App.__proto__ || __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_get_prototype_of___default()(App)).call(this, props));

        _this4.removeItem = function () {
            if (_this4.state.items.length <= 2) {
                alert("Cannot remove: please keep at least 2 items.");
            } else {
                _this4.setState({
                    items: _this4.state.items.slice(0, _this4.state.items.length - 1)
                });
            }
        };

        _this4.addItem = function () {
            var newItemKey = _this4.state.itemsKeys[_this4.state.items.length % _this4.state.itemsKeys.length];
            var newItemText = [newItemKey, newItemKey, newItemKey].join('');
            var newItemBkg = _this4.state.itemsBkgs[_this4.state.items.length % _this4.state.itemsBkgs.length];
            _this4.setState({
                items: _this4.state.items.concat([{
                    text: newItemText,
                    short: newItemKey,
                    bkg: newItemBkg
                }])
        ...
        _this4.prev = function () {
            _this4.accordion.prev();
        };

        _this4.next = function () {
            _this4.accordion.next();
        };

        _this4.state = {
            itemsKeys: "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
            itemsBkgs: ['#f00', '#ff0', '#f0f', '#0ff', '#00f'],
            items: [{ text: "AAA", short: "e", bkg: '#f00' }, { text: "BBB", short: "d", bkg: '#ff0' }, { text: "CCC", short: "1", bkg: '#f0f' }, { text: "DDD", short: "b", bkg: '#0ff' }, { text: "EEE", short: "a", bkg: '#00f' }]
        };
        return _this4;
    }
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(App, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
                    'button',
                    { type: 'button', onClick: this.removeItem },
                    'Remove Item'
                ),
                __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
                    'button',
                ...
                __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(Accordion, { items: state.items, ref: function ref(x) {
                        return _this5.accordion = x;
                    } })
            );
        }
    }]);
...
__WEBPACK_IMPORTED_MODULE_7_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(App, null), document.querySelector("#app"));
...
*/
var aa=__webpack_require__(20),ba=__webpack_require__(22),m=__webpack_require__(48),p=__webpack_require__(21),v=__webpack_require__(13),da=__webpack_require__(50),ea=__webpack_require__(51),fa=__webpack_require__(49),ha=__webpack_require__(19);
