...
module.exports = function(params){
    ...
    const headerHtml = fs.readFileSync('src/_header.html', 'utf8')
    
    //const mainHtml = fs.readFileSync('src/_main.html', 'utf8')
    const mainHtml = (new showdown.Converter()).makeHtml(readmeMd)

    const footerHtml = fs.readFileSync('src/_footer.html', 'utf8') || ''
