...
function f() {
    ...
    console.log('            f(x=100): typeof x: %s, x: %o', typeof x === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(x), x);
}

function g(x) {
    x = x || 100;
    console.log('g(x){ x = x || 100 }: typeof x: %s, x: %o', typeof x === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(x), x);
}
